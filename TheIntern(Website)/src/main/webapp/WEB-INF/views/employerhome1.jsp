...
<form action="postjob" method="get" role="form">
...
<a href="${pageContext.request.contextPath}/logout.htm" class="btn btn-primary btn-block">Log Out</a> 
 ...
 <table class="table table-hover">
            <tr>
                ...
                <td align="center"><b>View Applicants</b></td>
            ...
            <c:forEach var="adv" items="${jobList}">
                <tr>
                   <td align="center">${adv.id}</td>
                     <td align="center">${adv.date}</td>
                   <td align="center">${adv.jobTitle}</td>
                    <td align="center">${adv.industry}</td>
                   <!--  <td><button type="submit" class="btn btn-success">View</button></td> -->
                      <td align="center"><a href="viewapplicants/${adv.id }.htm"  role="button"><span class="glyphicon glyphicon-user"></span></a></td>
               <!--  <td align="center"><a href="${pageContext.request.contextPath}/deletejob/${adv.id }.htm"><span class="glyphicon glyphicon-remove"></span></a></td> -->
                </tr>
            </c:forEach>
        </table>
...
<div><c:if test="${!empty requestScope.error}">
                <p style="color:red">No Applicants</p>
            </c:if></div>
		<!-- /container -->
