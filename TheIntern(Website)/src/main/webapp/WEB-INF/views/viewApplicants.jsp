...
<a href="${pageContext.request.contextPath}/logout.htm" class="btn btn-primary btn-block">Log Out</a> 
			...
			<div class="col-md-8">
				<div class="col-md-4 user1">
					<div id="loginbox" style="margin-left: -40px;"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<div class="panel-title">View Applicants</div>
 ...
 <table class="table table-hover">
            ...
            <c:forEach var="adv" items="${applicants}">
                <tr>
                   <td>${adv.jobseeker.personID}</td>
                   
                   <td><a href="${pageContext.request.contextPath}/download/${adv.id}.htm" role="button">Download Resume</a> 
         </td>
         <td> ${adv.date}</td>
     
<td><a href="${pageContext.request.contextPath}/changeStatus/${adv.id}.htm"  id="myAnchor" class="btn btn-success" role="button">Submit Status</a></td>
