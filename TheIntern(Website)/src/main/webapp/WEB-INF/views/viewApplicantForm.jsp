			...
			<div class="col-md-8">
				<div class="col-md-4 user1">
					<div id="loginbox" style="margin-left: -40px;"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<div class="panel-title">Submit Status</div>
							...
							<div style="padding-top: 30px" class="panel-body">
								...
								<div style="display: none" id="login-alert"
									class="alert alert-danger col-sm-12"></div>
 <form action="${pageContext.request.contextPath}/postStatus/${status.id}.htm"   method="post">
...
<tr>
<td>${status.jobseeker.firstName}</td>
<td><select name="status" id="myDiv" class="form-control" >
