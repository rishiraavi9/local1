...
public class ManageParkingRequest extends javax.swing.JPanel {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String price1=priceJTex.getText();
        
        if(priceJTex.getText().trim().isEmpty()){
        JOptionPane.showMessageDialog(null,"Please Enter the Price");
        return;
        }
        else if (!isFloat(price1)){
            JOptionPane.showMessageDialog(null, "Price should be numbers");
            return;
        } else if (Integer.parseInt(String.valueOf(price1)) <= 0) {
            JOptionPane.showMessageDialog(null, "Please Enter Positive Price Value");
            return;
        } 
