 ...
 * @author RishikRaavi
 */
public class ManagePollutionOrganizationJPanel extends javax.swing.JPanel {
    ...
    public ManagePollutionOrganizationJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Polltuion Organization");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/PollutionWorkArea/Coal powerplant M.jpg"))); // NOI18N
...
public void populateCombo() {
        ...
        for (Organization.Type type : Organization.Type.values()) {
            if (type.getValue().equals(Organization.Type.PollutionControlAdmin.getValue()) || type.getValue().equals(Organization.Type.PollutionTracker.getValue())) {
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        for (Organization organ : enterprise.getOrganizationDirectory().getOrganizationList()) {
            if(organ instanceof PollutionControlAdminOrganization && type == PollutionControlAdmin ){
               JOptionPane.showMessageDialog(null,"PollutionControlAdminOrganization already exists");
                return;
            }
            else if( organ instanceof PollutionTrackerOrganization && type == PollutionTracker){
                JOptionPane.showMessageDialog(null,"PollutionTrackerOrganization already exists");
                return;
        ...
        if ((type.getValue().equals(Organization.Type.PollutionTracker.getValue()))) {
